...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: upstream
    <div
      role="group"
      data-slot="field"
...
function FieldError({
  ...
  const content = useMemo(() => {
    ...
    // biome-ignore lint/suspicious/noDoubleEquals: upstream
    ...
    return (
      <ul className="ml-4 flex list-disc flex-col gap-1">
        {uniqueErrors.map(
          (error, index) =>
            // biome-ignore lint/suspicious/noArrayIndexKey: upstream
